    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button size="sm" variant="default" className="h-8 gap-2">
          ...
          <span className="xl:whitespace-nowrap">Mời app</span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent>
        <DropdownMenuItem>
          ...
          >
            ...
            <span className="xl:whitespace-nowrap">Thêm app vào server</span>
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem>
          <Link
          ...
          >
            <ExternalLinkIcon className="h-3.5 w-3.5" />
            <span className="xl:whitespace-nowrap">Thêm app vào tài khoản</span>
          </Link>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
