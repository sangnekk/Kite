  ...
  return (
    <Card className="shadow-md max-w-96 fixed bottom-5 right-5 ml-5 z-50">
      <CardHeader className="px-5 py-4">
        <CardTitle className="text-lg">Vibe Bot ♥️</CardTitle>
        <CardDescription>
          Đây là dự án mã nguồn mở và gần như hoàn toàn miễn phí. Nếu bạn
          thích,{" "}
          <span className="text-foreground">
            hãy ủng hộ dự án bằng cách nâng cấp Premium
          </span>{" "}
          hoặc gắn sao trên Github.
        </CardDescription>
        <Button
          variant="ghost"
          size="icon"
