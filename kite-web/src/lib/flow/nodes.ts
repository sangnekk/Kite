...
import {
  ...
  nodeActionMemberVoiceMoveDataSchema,
  nodeActionMemberVoiceDisconnectDataSchema,
  nodeActionMemberVoiceMuteDataSchema,
  nodeActionMemberVoiceDeafenDataSchema,
  ...
  nodeActionListSortDataSchema,
  nodeActionListReverseDataSchema,
  nodeActionRegexMatchDataSchema,
  nodeActionTimeMathDataSchema,
  nodeActionTimeDiffDataSchema,
  ...
  nodeActionTableInsertDataSchema,
  nodeActionTableFindOneDataSchema,
  nodeActionTableQueryDataSchema,
  nodeActionTableUpdateDataSchema,
  nodeActionTableDeleteDataSchema,
...
import {
  ...
  nodeActionTableInsertResultSchema,
  nodeActionTableFindOneResultSchema,
  nodeActionTableQueryResultSchema,
  nodeActionTableMutationResultSchema,
} from "./resultSchema";
...
export const nodeTypes: Record<string, NodeValues> = {
  ...
  action_member_voice_move: {
    ...
    defaultTitle: "Chuyển kênh thoại",
    defaultDescription: "Chuyển thành viên sang kênh thoại khác",
    dataSchema: nodeActionMemberVoiceMoveDataSchema,
    dataFields: [
      "user_target",
      "channel_target",
      "audit_log_reason",
  ...
  action_member_voice_disconnect: {
    color: actionColor,
    icon: "phone-off",
    defaultTitle: "Ngắt khỏi kênh thoại",
    defaultDescription: "Ngắt thành viên khỏi kênh thoại",
    dataSchema: nodeActionMemberVoiceDisconnectDataSchema,
    dataFields: ["user_target", "audit_log_reason", "custom_label"],
    creditsCost: 1,
  },
  action_member_voice_mute: {
    color: actionColor,
    icon: "mic-off",
    defaultTitle: "Tắt/bật tiếng thoại",
    defaultDescription: "Tắt hoặc bật tiếng thành viên trong kênh thoại",
    dataSchema: nodeActionMemberVoiceMuteDataSchema,
    dataFields: [
      "user_target",
      "member_voice_mute",
      "audit_log_reason",
  ...
  action_member_voice_deafen: {
    color: actionColor,
    icon: "volume-off",
    defaultTitle: "Chặn/bỏ chặn nghe",
    defaultDescription: "Chặn hoặc bỏ chặn nghe của thành viên trong kênh thoại",
    dataSchema: nodeActionMemberVoiceDeafenDataSchema,
    dataFields: [
      "user_target",
      "member_voice_deafen",
      "audit_log_reason",
  ...
  action_time_math: {
    color: actionColor,
    icon: "calculator",
    defaultTitle: "Cộng/trừ thời gian",
    defaultDescription: "Cộng hoặc trừ một khoảng thời gian vào mốc thời gian",
    dataSchema: nodeActionTimeMathDataSchema,
    dataFields: [
      "time_input",
      "time_amount",
      "time_unit",
  ...
  action_time_diff: {
    color: actionColor,
    icon: "diff",
    defaultTitle: "Khoảng cách thời gian",
    defaultDescription: "Tính khoảng cách giữa hai mốc thời gian theo đơn vị",
    dataSchema: nodeActionTimeDiffDataSchema,
    dataFields: [
      "time_a",
      "time_b",
      "time_unit",
  ...
  action_regex_match: {
    color: actionColor,
    icon: "regex",
    defaultTitle: "So khớp Regex",
    defaultDescription: "Khớp văn bản với biểu thức chính quy, lấy nhóm bắt được",
    dataSchema: nodeActionRegexMatchDataSchema,
    resultSchema: nodeActionRegexMatchResultSchema,
    dataFields: [
      "text_input",
      "regex_pattern",
      "regex_flags",
  ...
  action_list_sort: {
    color: actionColor,
    icon: "arrow-down-up",
    defaultTitle: "Sắp xếp danh sách",
    defaultDescription: "Sắp xếp danh sách tăng hoặc giảm dần",
    dataSchema: nodeActionListSortDataSchema,
    dataFields: [
      "list_input",
      "list_sort_order",
      "temporary_name",
  ...
  action_list_reverse: {
    color: actionColor,
    icon: "rotate-ccw",
    defaultTitle: "Đảo danh sách",
    defaultDescription: "Đảo ngược thứ tự các phần tử trong danh sách",
    dataSchema: nodeActionListReverseDataSchema,
    dataFields: ["list_input", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_json_parse: {
  ...
  action_table_insert: {
    color: actionColor,
    icon: "database-zap",
    defaultTitle: "Thêm dòng dữ liệu",
    defaultDescription: "Thêm một bản ghi mới vào bảng dữ liệu.",
    dataSchema: nodeActionTableInsertDataSchema,
    resultSchema: nodeActionTableInsertResultSchema,
    dataFields: [
      "custom_table_id",
      "table_scope_id",
      "table_fields",
  ...
  action_table_find_one: {
    color: actionColor,
    icon: "scan-search",
    defaultTitle: "Tìm một dòng",
    defaultDescription: "Tìm bản ghi đầu tiên khớp bộ lọc.",
    dataSchema: nodeActionTableFindOneDataSchema,
    resultSchema: nodeActionTableFindOneResultSchema,
    dataFields: [
      "custom_table_id",
      "table_scope_id",
      "table_filters",
  ...
  action_table_query: {
    color: actionColor,
    icon: "rows-3",
    defaultTitle: "Truy vấn bảng",
    defaultDescription: "Lấy danh sách bản ghi có lọc, sắp xếp và phân trang.",
    dataSchema: nodeActionTableQueryDataSchema,
    resultSchema: nodeActionTableQueryResultSchema,
    dataFields: [
      "custom_table_id",
      "table_scope_id",
      "table_filters",
  ...
  action_table_update: {
    ...
    defaultTitle: "Cập nhật dòng dữ liệu",
    defaultDescription: "Cập nhật các bản ghi khớp bộ lọc.",
    dataSchema: nodeActionTableUpdateDataSchema,
    resultSchema: nodeActionTableMutationResultSchema,
    dataFields: [
      "custom_table_id",
      "table_scope_id",
      "table_filters",
  ...
  action_table_delete: {
    color: actionColor,
    icon: "trash-2",
    defaultTitle: "Xóa dòng dữ liệu",
    defaultDescription: "Xóa các bản ghi khớp bộ lọc.",
    dataSchema: nodeActionTableDeleteDataSchema,
    resultSchema: nodeActionTableMutationResultSchema,
    dataFields: [
      "custom_table_id",
      "table_scope_id",
