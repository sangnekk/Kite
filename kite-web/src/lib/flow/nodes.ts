...
import {
  ...
  nodeActionMessageUnpinDataSchema,
  nodeActionMessagePurgeDataSchema,
  nodeActionChannelSlowmodeDataSchema,
  nodeActionPrivateMessageCreateDataSchema,
  nodeActionTimeNowDataSchema,
  ...
  nodeActionJSONParseDataSchema,
  nodeActionJSONBuildDataSchema,
  nodeActionBalanceGetDataSchema,
  nodeActionBalanceAddDataSchema,
  nodeActionBalanceRemoveDataSchema,
  nodeActionBalanceSetDataSchema,
  nodeActionBalanceTransferDataSchema,
  nodeActionBalanceLeaderboardDataSchema,
  nodeActionCooldownCheckDataSchema,
...
export const nodeTypes: Record<string, NodeValues> = {
  ...
  action_message_pin: {
    color: actionColor,
    icon: "pin",
    defaultTitle: "Ghim tin nhắn",
    defaultDescription: "Bot ghim một tin nhắn trong kênh",
  ...
  action_message_unpin: {
    color: actionColor,
    icon: "pin-off",
    defaultTitle: "Bỏ ghim tin nhắn",
    defaultDescription: "Bot bỏ ghim một tin nhắn trong kênh",
    dataSchema: nodeActionMessageUnpinDataSchema,
    dataFields: [
      "channel_target",
      "message_target",
      "audit_log_reason",
  ...
  action_message_purge: {
    color: actionColor,
    icon: "trash-2",
    defaultTitle: "Xóa hàng loạt",
    defaultDescription: "Bot xóa nhiều tin nhắn gần nhất trong kênh",
    dataSchema: nodeActionMessagePurgeDataSchema,
    dataFields: [
      "channel_target",
      "message_purge_count",
      "audit_log_reason",
  ...
  action_channel_slowmode: {
    color: actionColor,
    icon: "timer",
    defaultTitle: "Đặt slowmode",
    defaultDescription: "Bot đặt thời gian chờ giữa các tin nhắn trong kênh",
    dataSchema: nodeActionChannelSlowmodeDataSchema,
    dataFields: [
      "channel_target",
  ...
  action_role_create: {
    color: actionColor,
    icon: "bookmark-plus",
    defaultTitle: "Tạo vai trò",
    defaultDescription: "Tạo một vai trò mới",
    dataSchema: nodeActionRoleCreateDataSchema,
    resultSchema: nodeActionRoleCreateResultSchema,
    dataFields: [
      "guild_target",
      "role_data",
      "audit_log_reason",
  ...
  action_role_edit: {
    color: actionColor,
    icon: "square-pen",
    defaultTitle: "Sửa vai trò",
    defaultDescription: "Sửa vai trò",
    dataSchema: nodeActionRoleEditDataSchema,
    resultSchema: nodeActionRoleEditResultSchema,
    dataFields: [
      "guild_target",
      "role_target",
      "role_data",
  ...
  action_role_delete: {
    color: actionColor,
    icon: "bookmark-x",
    defaultTitle: "Xóa vai trò",
    defaultDescription: "Xóa vai trò",
    dataSchema: nodeActionRoleDeleteDataSchema,
    dataFields: ["guild_target", "role_target", "custom_label"],
    creditsCost: 1,
  },
  action_guild_get: {
    color: actionColor,
  ...
  action_time_now: {
    color: actionColor,
    icon: "clock",
    defaultTitle: "Lấy thời gian hiện tại",
    defaultDescription: "Lấy thời gian hiện tại theo định dạng đã chọn",
    dataSchema: nodeActionTimeNowDataSchema,
    dataFields: ["time_format", "time_timezone", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_list_pick: {
    color: actionColor,
    icon: "shuffle",
    defaultTitle: "Chọn ngẫu nhiên từ danh sách",
    defaultDescription: "Chọn ngẫu nhiên một phần tử trong danh sách",
    dataSchema: nodeActionListPickDataSchema,
    dataFields: ["list_pick_input", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_text_transform: {
    color: actionColor,
    icon: "type",
    defaultTitle: "Biến đổi văn bản",
    defaultDescription: "Chuyển hoa/thường, cắt khoảng trắng, thay thế, tách văn bản",
    dataSchema: nodeActionTextTransformDataSchema,
    dataFields: [
      "text_input",
      "text_operation",
      "text_arg1",
  ...
  action_number_format: {
    color: actionColor,
    icon: "hash",
    defaultTitle: "Định dạng số",
    defaultDescription: "Định dạng số: dấu phẩy nghìn, rút gọn K/M, hoặc số thập phân",
    dataSchema: nodeActionNumberFormatDataSchema,
    dataFields: [
      "number_input",
      "number_style",
      "number_decimals",
  ...
  action_list_format: {
    color: actionColor,
    icon: "list",
    defaultTitle: "Định dạng danh sách",
    defaultDescription: "Render mỗi phần tử theo mẫu rồi nối lại (vd bảng xếp hạng)",
    dataSchema: nodeActionListFormatDataSchema,
    dataFields: [
      "list_input",
      "list_item_template",
      "list_joiner",
  ...
  action_list_join: {
    color: actionColor,
    icon: "list",
    defaultTitle: "Nối danh sách",
    defaultDescription: "Nối các phần tử của danh sách thành một chuỗi",
    dataSchema: nodeActionListJoinDataSchema,
    dataFields: ["list_input", "list_joiner", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_list_length: {
    color: actionColor,
    icon: "list-ordered",
    defaultTitle: "Độ dài danh sách",
    defaultDescription: "Đếm số phần tử trong danh sách",
    dataSchema: nodeActionListLengthDataSchema,
    dataFields: ["list_input", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_json_parse: {
    color: actionColor,
    icon: "braces",
    defaultTitle: "Phân tích JSON",
    defaultDescription: "Chuyển chuỗi JSON thành đối tượng để truy cập các trường",
    dataSchema: nodeActionJSONParseDataSchema,
    dataFields: ["json_input", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_json_build: {
    color: actionColor,
    icon: "braces",
    defaultTitle: "Tạo JSON",
    defaultDescription: "Chuyển một giá trị thành chuỗi JSON",
    dataSchema: nodeActionJSONBuildDataSchema,
    dataFields: ["json_input", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_balance_get: {
    color: actionColor,
    icon: "wallet",
    defaultTitle: "Xem số dư",
    defaultDescription: "Lấy số dư của một người dùng",
    dataSchema: nodeActionBalanceGetDataSchema,
    dataFields: ["variable_id", "economy_user_target", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_balance_add: {
    color: actionColor,
    icon: "circle-plus",
    defaultTitle: "Cộng số dư",
    defaultDescription: "Cộng tiền vào số dư của một người dùng",
    dataSchema: nodeActionBalanceAddDataSchema,
    dataFields: [
      "variable_id",
      "economy_user_target",
      "economy_amount",
  ...
  action_balance_remove: {
    color: actionColor,
    icon: "circle-minus",
    defaultTitle: "Trừ số dư",
    defaultDescription: "Trừ tiền khỏi số dư của một người dùng",
    dataSchema: nodeActionBalanceRemoveDataSchema,
    dataFields: [
      "variable_id",
      "economy_user_target",
      "economy_amount",
      "economy_allow_negative",
      "temporary_name",
      "custom_label",
    ],
    creditsCost: 1,
  ...
  action_balance_set: {
    color: actionColor,
    icon: "equal",
    defaultTitle: "Đặt số dư",
    defaultDescription: "Đặt số dư của một người dùng thành giá trị cố định",
    dataSchema: nodeActionBalanceSetDataSchema,
    dataFields: [
      "variable_id",
      "economy_user_target",
      "economy_amount",
  ...
  action_balance_transfer: {
    ...
    defaultTitle: "Chuyển tiền",
    defaultDescription: "Chuyển tiền từ một người dùng sang người khác",
    dataSchema: nodeActionBalanceTransferDataSchema,
    dataFields: [
      "variable_id",
      "economy_user_target",
      "economy_recipient",
  ...
  action_balance_leaderboard: {
    color: actionColor,
    icon: "trophy",
    defaultTitle: "Bảng xếp hạng",
    defaultDescription: "Lấy danh sách những người có số dư cao nhất",
    dataSchema: nodeActionBalanceLeaderboardDataSchema,
    dataFields: ["variable_id", "economy_limit", "temporary_name", "custom_label"],
    creditsCost: 1,
  },
  action_cooldown_check: {
    color: actionColor,
    icon: "timer",
    defaultTitle: "Kiểm tra cooldown",
    defaultDescription: "Kiểm tra và đặt lại thời gian chờ theo người dùng",
    dataSchema: nodeActionCooldownCheckDataSchema,
    dataFields: [
      "variable_id",
      "cooldown_scope",
      "cooldown_duration",
