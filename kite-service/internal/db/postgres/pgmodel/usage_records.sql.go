...
INSERT INTO usage_records (
    ...
    $1, $2, $3, $4, $5, $6, $7, $8
) RETURNING id, type, app_id, command_id, event_listener_id, message_id, credits_used, created_at, schedule_id
`
...
SELECT id, type, app_id, command_id, event_listener_id, message_id, credits_used, created_at, schedule_id FROM usage_records WHERE app_id = $1 AND created_at BETWEEN $2 AND $3 ORDER BY created_at DESC
`
